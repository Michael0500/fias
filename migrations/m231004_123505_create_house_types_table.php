...
class m231004_123505_create_house_types_table extends Migration
{
    public function safeUp()
    {
        $this->createTable('{{%house_types}}', [
            'id' => $this->bigInteger()->notNull()->unique()->comment('Идентификатор типа (10 цифр)'),
...
//        $this->createIndex('idx_house_types_ISACTIVE', '{{%house_types}}', 'ISACTIVE');
        ...
        $sql = <<<SQL
CREATE OR REPLACE PROCEDURE import_housetypes_from_xml(xml_path TEXT)
LANGUAGE plpgsql
AS
$$
BEGIN
...
SQL;
    ...
    public function safeDown()
    {
        ...
        $this->execute('DROP PROCEDURE IF EXISTS import_housetypes_from_xml(TEXT)');
    }
}